...
namespace spawn_overlays
{
	...
	public:
		struct SPack
		{
			...
			xr_vector<GameGraph::_LEVEL_ID> levels;
			...
			// levels this pack could not append or substitute (not installed, wrong build, no [levelNN] section,
			// id mismatch, vertex limit reached).
