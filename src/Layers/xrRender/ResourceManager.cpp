...
Shader *CResourceManager::_cpp_Create(LPCSTR s_shader, LPCSTR s_textures,
                                      LPCSTR s_constants, LPCSTR s_matrices) {
...
#endif
  {
    ...
    return _cpp_Create(_GetBlender(s_shader ? s_shader : "null"), s_shader,
                       s_textures, s_constants, s_matrices);
#endif //	USE_DX10
       // #else
  }
#ifndef _EDITOR
...
Shader *CResourceManager::Create(IBlender *B, LPCSTR s_shader,
                                 LPCSTR s_textures, LPCSTR s_constants,
                                 LPCSTR s_matrices) {
  // #ifndef DEDICATED_SERVER
#ifndef _EDITOR
...
void CResourceManager::DeferredUnload() {
  ...
  tbb::parallel_for_each(m_textures,
                         [&](auto m_tex) { m_tex.second->Unload(); });
}
...
void CResourceManager::_GetMemoryUsage(u32 &m_base, u32 &c_base, u32 &m_lmaps,
                                       u32 &c_lmaps) {
